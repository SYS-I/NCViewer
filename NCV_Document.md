...
- [9. 詳細情報（既存製品ヘルプ情報抜粋）](#9-詳細情報既存製品ヘルプ情報抜粋)
    ...
    - [9.4. バージョンアップ履歴](#94-バージョンアップ履歴)
        ...
        - [9.4.54. Version 3.61 (2008/07/11)](#9454-version-361-20080711)
        ...
        - [9.4.118. Version 1.42  (2000/01/14)](#94118-version-142--20000114)
...
読み込み時にNCリストのワーニングメッセージやレポートでワーニングが表示されていないか確認します。
...
工具の形状情報の抽出を[オプション（ミル・旋盤・ワイヤー）](#86-オプションミル旋盤ワイヤー)で設定します。
...
<img src='MD_Data/Image_NCV_Document/2022-09-15-18-25-47.png' width='60%'/>
...
#### 6.1.2. 機械データ/リファレンス図形の自動抽出フォーマット
...
この画面で切替えると機能コード・アドレス等が初期化されます。

| No  |   項目   |              内容              |    備考     |
| --- | -------- | ------------------------------ | ----------- |
| 1   | ミル     | ミル加工の時に指定します。     | mdlファイル |
| 2   | 旋盤     | 旋盤加工の時に指定します。     | ldlファイル |
| 3   | ワイヤー | ワイヤー加工の時に指定します。 | wdlファイル |

機械の種類を切り替えるときは、`開く`ボタンよりファイルの種類の切り替えとファイルを選択し開きなおします。

<img src='MD_Data/Image_NCV_Document/2022-09-15-17-20-43.png' width='60%'/>
...
| No  | 項目  | フォーマット |             備考             |
| --- | ----- | ------------ | ---------------------------- |
| 1   | X座標 | %x           | 通常半角小文字で記述します。 |
| 2   | Y座標 | %y           | "                            |
| 3   | Z座標 | %z           | "                            |

※大文字で記載した場合、整数から実数への変換は行いません。

### 7.10. 径補正

<img src='MD_Data/Image_NCV_Document/2022-06-27-11-14-11.png' width='80%'/><br>

#### 7.10.1. 径補正のスタートアップ、キャンセルの動き
...
| 3   | 番号       | 工具番号を０～９９９９９９９９ の範囲で指定します。            | ０番は工具が未選択時に参照されます |
| 4   | 名前       | 工具名称です。                                                 |                                    |
| 5   | 直径       | 工具直径です。                                                 |                                    |
...
| 3   | 番号       | 電気条件番号を０～９９９９９９９９ の範囲で指定します。            | ０番は電気条件が未選択時に参照されます |
| 4   | 名前       | 電気条件の名称です。                                               |                                        |
| 5   | 直径       | ワイヤー直径を入力します。                                         |                                        |
...
#### 8.3.1. ワイヤー 電気条件 編集ダイアログ

<img src='MD_Data/Image_NCV_Document/2022-09-14-18-36-30.png' width='60%'/>

### 8.4. 径補正番号（ミル・旋盤・ワイヤー）

<img src='MD_Data/Image_NCV_Document/2022-06-27-11-15-17.png' width='80%'/><br>

| No  |     項目     |                                内容                                |                    備考                    |
| --- | ------------ | ------------------------------------------------------------------ | ------------------------------------------ |
| 1   | *            | プログラム内で指定がない時に使用される補正番号にマークがつきます。 |                                            |
| 2   | 番号         | 径補正番号を０～９９９９ の範囲で指定します。                      | ０番は補正番号が未設定の場合に参照されます |
| 3   | オフセット値 | 補正量を入力します。                                               |                                            |
| 7   | すべて削除   | 登録されている電気条件をすべて削除します。                         |                                            |
| 8   | 追加         | 径補正を追加します。                                               |                                            |
| 9   | 削除         | 選択している径補正を削除します。                                   |                                            |
| 10  | 編集         | 編集ダイアログが開きます。                                         |                                            |

<img src='MD_Data/Image_NCV_Document/2022-09-14-18-56-32.png' width='60%'/>
...
### 8.6. オプション（ミル・旋盤・ワイヤー）

<img src='MD_Data/Image_NCV_Document/2022-06-27-11-15-31.png' width='80%'/><br>

| No  |                             項目                             |                                   内容                                   | 備考 |
| --- | ------------------------------------------------------------ | ------------------------------------------------------------------------ | ---- |
| 1   | NCデータの工具番号、径補正番号を反映する                     | 補正状態を反映させる時にチェックします。                                 |      |
| 2   | NCデータの（コメント）から詳細情報を自動抽出する             | 補正情報をコメントから抽出する時にチェックします。                       |      |
| 3   | 解析フォーマット１                                           |                                                                          |      |
| 7   | 解析フォーマット２                                           |                                                                          |      |
| 8   | 解析フォーマット３                                           |                                                                          |      |
| 9   | 径補正値の設定がない場合は、モーダル工具番号の直径を参照する | 径補正値は 『工具径の何パーセント』 と決まっている場合などに使用します。 |      |

#### 8.6.1. 解析フォーマット変数

| No  | 変数 |        名称        |                                                                                                                                                                     内容                                                                                                                                                                     |
| --- | ---- | ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | %t   | 工具番号           | 記載がない場合は、現在のモーダル工具番号になります                                                                                                                                                                                                                                                                                           |
| 2   | %r   | 工具直径           | mm単位です                                                                                                                                                                                                                                                                                                                                   |
| 3   | %u   | 工具半径／ノーズＲ | mm単位です                                                                                                                                                                                                                                                                                                                                   |
| 4   | %l   | 工具有効長         | mm単位です（ミル用）                                                                                                                                                                                                                                                                                                                         |
| 5   | %e   | 先端Ｒ             | ラジアス系の場合の先端Ｒ（ミル用）                                                                                                                                                                                                                                                                                                           |
| 6   | %a   | テーパー角         | テーパー系の場合のテーパー角度（ミル用）                                                                                                                                                                                                                                                                                                     |
| 7   | %b   | 下面径             | テーパー系の場合の下面径（ミル用）                                                                                                                                                                                                                                                                                                           |
| 8   | %n   | 工具名称           | スペースコードを含んでいる場合は "工具 名称" のように区切り文字を記載します。<br>例）コメント ( T=99 GROUP1 CDA 10.0 ) を認識させるには<br>( T=99 GROUP1 CDA 10.0 ) を ( T=99 "GROUP1 CDA" 10.0 ) のように変更して下さい。<br>その場合の解析フォーマットは [T=%t "%n" %r] となります。<br>旋盤の場合、バイト図形ファイル名として扱われます。 |
| 9   | %p   | ノーズ刃先位置     | 1 ～ 9（旋盤用）                                                                                                                                                                                                                                                                                                                             |
| 10  | %c   | 表示色             | カラー変数の説明 を参照                                                                                                                                                                                                                                                                                                                      |
| 11  | %d   | 径補正番号         | 記載がない場合は、現在のモーダル補正番号になります                                                                                                                                                                                                                                                                                           |
| 12  | %o   | 径補正値           | mm単位です                                                                                                                                                                                                                                                                                                                                   |
| 13  | %h   | 長補正番号         | 記載がない場合は、現在のモーダル補正番号になります                                                                                                                                                                                                                                                                                           |
| 14  | %v   | 長補正値           | mm単位です                                                                                                                                                                                                                                                                                                                                   |
| 15  | %s   | ヘッド傾き角度     | 0 ～ 180 度                                                                                                                                                                                                                                                                                                                                  |
| 16  | %w   | ヘッド傾き方向     | -360 ～ 360 度                                                                                                                                                                                                                                                                                                                               |
| 17  | %x   | ヘッドピッチＸ     | mm単位です                                                                                                                                                                                                                                                                                                                                   |
| 18  | %y   | ヘッドピッチＹ     | mm単位です                                                                                                                                                                                                                                                                                                                                   |
| 19  | %z   | ヘッドピッチＺ     | mm単位です                                                                                                                                                                                                                                                                                                                                   |
| 20  | %i   | ヘッド中心ズレ量Ｘ | mm単位です                                                                                                                                                                                                                                                                                                                                   |
| 21  | %j   | ヘッド中心ズレ量Ｙ | mm単位です                                                                                                                                                                                                                                                                                                                                   |
| 22  | %-   | １文字スキップ     | 他の解析フォーマットでも使用可                                                                                                                                                                                                                                                                                                               |
| 23  | %$   | １ワードスキップ   | 他の解析フォーマットでも使用可                                                                                                                                                                                                                                                                                                               |

- ＣＡＭ毎に(コメント)の記載方法が異なる場合は、工具ファイルを複数用意して下さい。
...
#### 9.4.10. Version 5.23 (2017/06/20)
...
#### 9.4.11. Version 5.22 (2016/10/27)
...
#### 9.4.12. Version 5.21 (2016/09/07)
...
#### 9.4.13. Version 5.20 (2016/05/12)
...
#### 9.4.14. Version 5.12 (2016/02/25)
...
#### 9.4.15. Version 5.11 (2016/01/12)
...
#### 9.4.16. Version 5.10 (2015/11/26)
...
#### 9.4.17. Version 5.00 (2015/08/20)
...
#### 9.4.18. Version 4.87 (2015/04/16)
...
#### 9.4.19. Version 4.86 (2015/01/15)
...
#### 9.4.20. Version 4.85 (2014/09/18)
...
#### 9.4.23. Version 4.82 (2014/01/15)
...
#### 9.4.24. Version 4.81 (2013/08/28)
...
#### 9.4.25. Version 4.80 (2013/05/08)
...
#### 9.4.26. Version 4.74 (2013/02/20)
...
#### 9.4.31. Version 4.60 (2012/08/01)
...
#### 9.4.32. Version 4.54 (2012/05/16)
...
#### 9.4.33. Version 4.53 (2012/04/18)
...
#### 9.4.36. Version 4.50 (2012/01/12)
...
#### 9.4.37. Version 4.40 (2011/11/16)
...
#### 9.4.38. Version 4.31 (2011/07/13)

1. レポートの切削範囲、移動範囲に必ず０値が参照されてしまう問題を修正しました。

#### 9.4.39. Version 4.30 (2011/05/18)
...
#### 9.4.40. Version 4.20 (2011/03/16)
...
#### 9.4.41. Version 4.12 (2010/11/17)

1. M05主軸停止において、Ｓモーダルをクリアするようにしました。

#### 9.4.42. Version 4.11 (2010/10/13)
...
#### 9.4.43. Version 4.10 (2010/09/09)
...
#### 9.4.44. Version 4.00 (2010/07/07)
...
#### 9.4.53. Version 3.62 (2008/08/04)
...
#### 9.4.54. Version 3.61 (2008/07/11)
...
#### 9.4.55. Version 3.60 (2008/06/20)
...
#### 9.4.56. Version 3.55 (2008/02/04)
...
#### 9.4.57. Version 3.54 (2007/11/22)
...
#### 9.4.58. Version 3.53 (2007/10/26)
...
#### 9.4.59. Version 3.52 (2007/10/15)
...
#### 9.4.60. Version 3.51 (2007/09/28)

1. ＮＣ構文以外の解析処理が終了しないケースを修正しました。
1. 旧ハードウェアライセンスで動作しないケースを修正しました。

#### 9.4.61. Version 3.50 (2007/09/20)
...
#### 9.4.62. Version 3.45 (2007/06/14)
...
#### 9.4.66. Version 3.41 (2007/04/06)
...
#### 9.4.67. Version 3.40 (2007/04/02)
...
#### 9.4.68. Version 3.31 (2007/02/26)
...
#### 9.4.69. Version 3.30 (2007/02/01)
...
#### 9.4.70. Version 3.21 (2006/12/15)
...
#### 9.4.71. Version 3.20 (2006/12/08)
...
#### 9.4.74. Version 2.47 (2007/04/02)

1. ＮＣデータの再読み込みで処理で、サブプロファイルが重複して読み込まれる問題を修正しました。
1. １行に複数の(コメント)があると正常に解析できない問題を修正しました。

#### 9.4.75. Version 2.46 (2007/02/01)
...
#### 9.4.76. Version 2.45 (2006/11/27)

1. 「スペース、タブコードを全て無視する」がコメント箇所に対しても効いてしまう問題を修正しました。

#### 9.4.77. Version 2.44 (2006/11/15)

1. 真円切削に対する領域計算の問題を修正しました。
1. 自動ブレイク文字、マーカー文字を変更した際の再読み込みで、変更した内容が反映されない問題を修正しました。

#### 9.4.78. Version 2.43  (2006/10/03)
...
#### 9.4.81. Version 2.40  (2006/02/14)
...
#### 9.4.82. Version 2.31  (2005/10/24)

1. 全円に対する領域計算が正常に求まらないケースを修正。
1. ＤＸＦ出力すると例外エラーが発生する問題を修正しました。

#### 9.4.83. Version 2.30  (2005/10/20)
...
#### 9.4.84. Version 2.24  (2005/07/15)
...
#### 9.4.85. Version 2.23  (2005/06/10)
...
#### 9.4.86. Version 2.22  (2004/11/26)
...
#### 9.4.87. Version 2.21  (2004/10/13)
...
#### 9.4.88. Version 2.20  (2004/09/13)
...
#### 9.4.89. Version 2.13  (2004/01/28)

1. ハードウェアプロテクタをチェーン接続した場合の問題を修正しました。

#### 9.4.90. Version 2.12  (2003/12/09)
...
#### 9.4.91. Version 2.11  (2003/09/29)

1. 固定サイクル描画で工具が９０度傾いてしまう問題を修正しました。

#### 9.4.92. Version 2.10  (2003/09/25)
...
#### 9.4.93. Version 2.01  (2003/06/02)
...
#### 9.4.94. Version 2.00  (2002/11/13)
...
#### 9.4.97. Version 1.92  (2002/06/26)
...
#### 9.4.98. Version 1.91  (2002/02/01)
...
#### 9.4.99. Version 1.90  (2001/11/01)
...
#### 9.4.100. Version 1.83  (2001/07/02)
...
#### 9.4.103. Version 1.80  (2001/01/09)
...
#### 9.4.104. Version 1.73  (2000/10/05)

1. Version1.72で工具ファイルの内容が抹消されてしまう問題を修正しました。

#### 9.4.105. Version 1.72  (2000/10/03)
...
#### 9.4.106. Version 1.71  (2000/08/21)

1. 読み込み時のワーニング表示の無効フラグを追加（プロパティ - ＮＣリスト）。
1. セキュリティーの変更。

#### 9.4.107. Version 1.70  (2000/07/25)
...
#### 9.4.108. Version 1.63  (2000/05/25)

1. プロテクトセキュリティの強化。

#### 9.4.109. Version 1.62  (2000/04/27)
...
#### 9.4.110. Version 1.61  (2000/04/14)
...
#### 9.4.111. Version 1.60  (2000/03/29)
...
#### 9.4.112. Version 1.52  (2000/03/03)
...
#### 9.4.113. Version 1.51  (2000/02/24)
...
#### 9.4.114. Version 1.50  (2000/02/18)
...
#### 9.4.118. Version 1.42  (2000/01/14)
...
#### 9.4.119. Version 1.41  (2000/01/12)
...
#### 9.4.120. Version 1.40  (1999/12/16)
...
#### 9.4.121. Version 1.30  (1999/11/29)
...
#### 9.4.122. Version 1.22  (1999/10/25)

1. マルチユーザーライセンスへの移行で登録済みライセンスが正常に移行しないパターンを修正。

#### 9.4.123. Version 1.21  (1999/10/08)
...
#### 9.4.124. Version 1.20  (1999/09/30)
...
#### 9.4.125. Version 1.10  (1999/09/14)
...
#### 9.4.126. Version 1.00  (1999/06/30)
